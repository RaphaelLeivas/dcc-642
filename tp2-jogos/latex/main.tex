...
\begin{table}[htbp] % [htbp] specifies preferred placement: here, top, bottom, page
    \centering % Centers the table on the page
    \caption{Resultados finais do experimento Minimax vs Aleatório.} % Table caption
    \label{tab:minimax-aleatorio} % Label for cross-referencing
